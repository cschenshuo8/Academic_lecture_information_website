...
url = "https://eecs.pku.edu.cn/info/1050/2172.htm"
...
items = re.split(r"专家简介：| Biography:|教授简介：|报告人简介：|主讲人介绍：", str(speaker_file))
if len(items) > 1:
    speaker_file = items[1]

#发布时间
ptimes = soup.find("div", attrs={"class": "info"})
...
csv_writer.writerow([title, speaker, time, location, "北京大学", web, publish_time, content, speaker_file])
